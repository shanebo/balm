...
exports.balm = (opts = {}) => {
  ...
  const _blocksDir = `${opts.root}/../.balm`;
  const _hashes = {};
  const _hasBundled = {};
  ...
  function startWatching() {
    ...
    _socket = new WebSocket.Server({ port: opts.port });
    addHmrToBundles(opts.port, _blocksDir);
    ...
    const balmFiles = chokidar.watch(`${opts.root}/**/*.balm`);
