...
const { hash, makeScopedClass, fileExtRegexStr, isDev, mapPath } = require('./utils');
...
function makeMap(opts) {
  const { templates, handlePaths, assets } = opts;
...
function esbuildDone(error, result, opts) {
  if (error) {
...
exports.esbuildDone = esbuildDone;
